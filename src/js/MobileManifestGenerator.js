				...
				switch(frameType) {
					...
					case "TEXT-OFFER-FRAME-TYPE-1" :
						if ( data.hasOwnProperty('unique-background') ) {
							...
							console.log("INFO: Offer frame type 1 background image is not used in JSONP file.");
						}
						if ( data.hasOwnProperty('headline-image') ) {
							...
							throw "ERROR: Offer frame type 1 headline image is missing in JSONP file.";
						}
						if ( data.hasOwnProperty('image') ) {
							console.log(data.image);
							object = {};
							...
							throw "ERROR: Offer frame type 1 frame image is missing in JSONP file.";
						}
						break;
					...
					case "TEXT-CONTENT-FRAME" :
						if ( data.hasOwnProperty('unique-background') ) {
							...
							console.log("INFO: Content frame background image is not used in JSONP file.");
						}
						if ( data.hasOwnProperty('headline-image') ) {
							contentFrameIndice = i;
							console.log(data['headline-image']);
							...
							throw "ERROR: Content frame headline image is missing in JSONP file.";
						}
						if ( data.hasOwnProperty('image') ) {
							console.log(data.image);
							object = {};
					...
					case "TEXT-PRICE-FRAME" :
						if ( data.hasOwnProperty('unique-background') ) {
							...
							console.log("INFO: Price frame background image is not used in JSONP file.");
						}
						if ( data.hasOwnProperty('headline-image') ) {
							contentFrameIndice = i;
							console.log(data['headline-image']);
					...
					case "TEXT-END-FRAME-TYPE-2" :
						...
						if ( data.hasOwnProperty('relational-image') ) {
							...
							console.log("INFO: Content frame headline image is missing in JSONP file.");
						}
						if ( data.hasOwnProperty('cta-image') ) {
							console.log(data['cta-image']);
							object = {};
