...
function createTextIntroductionFrame() {
	...
	headline.regY = 0;
	headline.x = currentFrame.hasOwnProperty('image-x-position') ? currentFrame['image-x-position'] : 79;
...
function createOfferFrameTypeOne() {
	...
	headline.regX = Math.floor(headline.image.width * 0.5);
	headline.regY = 0;
	headline.x = currentFrame.hasOwnProperty("headline-x-position") ? currentFrame['headline-x-position'] : 79;
	...
	if ( currentFrame.hasOwnProperty("relational-image") ) {
		...
		relational.regY = 0;
		relational.x = currentFrame.hasOwnProperty('relational-x-position') ? currentFrame['relational-x-position'] : 79;
...
function createRoundelFrame() {
	...
	if ( currentFrame.hasOwnProperty("roundel-sheen") ) {
		if ( currentFrame['roundel-sheen'] === "yes"  ) {
			...
			roundelSheenMask.x = 79;
			roundelSheenMask.y = 232;
