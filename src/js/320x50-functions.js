function createBannerLegals() {
	...
	legalButton.style.left = (content.hasOwnProperty("legal-label-position") ? content['legal-label-position'].left : 260) + "px";
	...
	if ( copy.clientHeight < 48 ) {
		legalContainer.style.backgroundPositionX = "304px";
...
function createSkyLogo() {
	...
	createjs.Tween.get(skyLogo,{ignoreGlobalPause:true}).to({alpha:1},500);	
}
...
function createIntroductionFrame() {
	if ( currentFrame.hasOwnProperty("unique-background") ) {
		...
		createjs.Tween.get(background,{ignoreGlobalPause:true}).to({alpha:1},500);
	}
	...
	if ( currentFrame.hasOwnProperty("image-sheen") && currentFrame["image-sheen"] === "yes" && currentFrame.gradient && currentFrame.gradient === "yes") {
		...
		mask1.rotation = 15;
		clone1.mask = mask1;
		createjs.Tween.get(mask1,{ignoreGlobalPause:true}).wait(parseInt(currentFrame['image-animation-in'].duration)).to({x:320},1000);
		...
		mask2.rotation = 15;
		clone2.mask = mask2;
		createjs.Tween.get(mask2,{ignoreGlobalPause:true}).wait(parseInt(currentFrame['image-animation-in'].duration)).to({x:320},1000);
	}
...
function createOfferFrameTypeOne() {
	...
	if ( currentFrame.hasOwnProperty("headline-sheen") && currentFrame["headline-sheen"] === "yes" && currentFrame.gradient && currentFrame.gradient === "yes") {
		...
		mask1.rotation = 15;
		clone1.mask = mask1;
		createjs.Tween.get(mask1,{ignoreGlobalPause:true}).wait(parseInt(currentFrame['headline-animation-in'].duration)).to({x:320},1000);
...
function createLeftRoundelFrame() {
	...
	if ( currentFrame.hasOwnProperty("roundel-sheen") ) {
		if ( currentFrame['roundel-sheen'] === "yes" ) {
			...
			createjs.Tween.get(roundelSheen,{ignoreGlobalPause:true}).wait(500).to({x:320},500).call(function(){
...
function createRightRoundelFrame() {
	...
	if ( currentFrame.hasOwnProperty("roundel-sheen") ) {
		if ( currentFrame['roundel-sheen'] === "yes" ) {
			...
			createjs.Tween.get(roundelSheen,{ignoreGlobalPause:true}).wait(1000).to({x:320},500).call(function(){
				stageContent.removeChild(roundelSheen);
			});
		}
	}
...
function createEndFrameTypeOne() {
	...
	headline.x = currentFrame.hasOwnProperty('headline-x-position') ? currentFrame['headline-x-position'] : 162;
	...
	callToAction.x = currentFrame.hasOwnProperty('cta-position') ? currentFrame['cta-position'].x : 162;
	...
	if ( currentFrame['cta-sheen'] === "yes" ) {
		...
		createjs.Tween.get(callToActionSheen,{ignoreGlobalPause:true}).wait(1500).to({x:320},500).call(function(){
...
function createEndFrameTypeTwo() {
	...
	if ( currentFrame.hasOwnProperty("headline-sheen") && currentFrame["headline-sheen"] === "yes" && currentFrame.gradient && currentFrame.gradient === "yes") {
		...
		mask2.rotation = 15;
		clone2.mask = mask2;
		createjs.Tween.get(mask2,{ignoreGlobalPause:true}).wait(parseInt(currentFrame['headline-animation-in'].duration)).to({x:320},1000);
	}
	else if ( currentFrame.hasOwnProperty("headline-sheen") && currentFrame["headline-sheen"] === "no" && currentFrame.gradient && currentFrame.gradient === "no" ) {
		animateStraplineIn(headline, currentFrame['headline-animation-in'], null);
	}
	...
	if ( currentFrame.hasOwnProperty("relational-sheen") && currentFrame["relational-sheen"] === "yes" && currentFrame["relational-gradient"] && currentFrame["relational-gradient"] === "yes") {
		...
		mask3.rotation = 15;
		clone3.mask = mask3;
		createjs.Tween.get(mask3,{ignoreGlobalPause:true}).wait(parseInt(currentFrame['relational-animation-in'].duration)).to({x:320},1000);
		...
		mask4.rotation = 15;
		clone4.mask = mask4;
		createjs.Tween.get(mask4,{ignoreGlobalPause:true}).wait(parseInt(currentFrame['relational-animation-in'].duration)).to({x:320},1000);
	}
