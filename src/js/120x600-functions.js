function createBannerLegals() {
	...
	legalButton.style.left = (content.hasOwnProperty("legal-label-position") ? content['legal-label-position'].left : 31) + "px";
	...
	if ( copy.clientHeight < 598 ) {
		legalContainer.style.backgroundPositionX = "103px";
...
function createTextIntroductionFrame() {
	...
	headline.regY = 0;
	headline.x = currentFrame.hasOwnProperty('image-x-position') ? currentFrame['image-x-position'] : 59;
	headline.y = currentFrame.hasOwnProperty('image-y-position') ? currentFrame['image-y-position'] : 70;
	headline.alpha = 0;
...
function createOfferFrameTypeOne() {
	...
	headline.regX = Math.floor(headline.image.width * 0.5);
	headline.regY = 0;
	headline.x = currentFrame.hasOwnProperty('headline-x-position') ? currentFrame['headline-x-position'] : 59;
	headline.y = currentFrame.hasOwnProperty("headline-y-position") ? currentFrame['headline-y-position'] : 70;
	headline.cache(0,0,headline.image.width,headline.image.height);
	...
	if ( currentFrame.hasOwnProperty("relational-image") ) {
		...
		relational.regY = 0;
		relational.x = currentFrame.hasOwnProperty('relational-x-position') ? currentFrame['relational-x-position'] : 59;
		relational.y = currentFrame.hasOwnProperty('relational-y-position') ? currentFrame['relational-y-position'] : 370;
		...
		if ( currentFrame.hasOwnProperty("relational-sheen") && currentFrame["relational-sheen"] === "yes" && currentFrame['relational-gradient'] && currentFrame['relational-gradient'] === "yes") {
			...
			mask3.rotation = 15;
			clone3.mask = mask3;
			createjs.Tween.get(mask3).wait(parseInt(currentFrame['relational-image-animation-in'].duration)).to({x:300},1000);
		}
			...
			mask4.rotation = 15;
			clone4.mask = mask4;
			createjs.Tween.get(mask4).wait(parseInt(currentFrame['relational-image-animation-in'].duration)).to({x:300},1000);
		}
...
function createContentFrame() {
	...
	if ( currentFrame.hasOwnProperty("relational-image") ) {
		...
		relational.regY = 0;
		relational.x = currentFrame.hasOwnProperty('relational-x-position') ? currentFrame['relational-x-position'] : 59;
		relational.y = currentFrame.hasOwnProperty('relational-y-position') ? currentFrame['relational-y-position'] : 480;
		relational.cache(0,0,relational.image.width,relational.image.height);
...
function createRoundelFrame() {
	...
	if ( currentFrame.hasOwnProperty("roundel-sheen") ) {
		if ( currentFrame['roundel-sheen'] === "yes"  ) {
			...
			roundelSheenMask.x = 59;
			roundelSheenMask.y = 233;
			...
			createjs.Tween.get(roundelSheen).wait(1000).to({x:200},500).call(function(){
	...
	if ( currentFrame.hasOwnProperty("relational-image") ) {
		...
		relational.regY = 0;
		relational.x = currentFrame.hasOwnProperty('relational-x-position') ? currentFrame['relational-x-position'] : 59;
		relational.y = currentFrame.hasOwnProperty('relational-y-position') ? currentFrame['relational-y-position'] : 315;
		relational.cache(0,0,relational.image.width,relational.image.height);
...
function createRoundelEndFrame() {
	...
	if ( currentFrame.hasOwnProperty("cta-sheen") && currentFrame['cta-sheen'] === "yes" ) {
		...
		callToActionMask.graphics.beginFill('red').drawRoundRect(0, 0, 90, 60, 8);
		callToActionMask.regX = 45;
		callToActionMask.regY = 30;
		callToActionMask.x = 59;
		callToActionMask.y = 264;
		...
		createjs.Tween.get(callToActionSheen).wait(1500).to({x:200},500).call(function(){
	...
	if ( currentFrame.hasOwnProperty("roundel-sheen") ) {
		if ( currentFrame['roundel-sheen'] === "yes" ) {
			...
			createjs.Tween.get(roundelSheen).wait(2000).to({x:200},500).call(function(){
				stageContent.removeChild(roundelSheen);
			});
		}
	}
...
function createCustomEndFrame() {
	...
	callToAction.regX = Math.floor(callToAction.image.width * 0.5);
	callToAction.regY = Math.floor(callToAction.image.height * 0.5);
	callToAction.x = currentFrame.hasOwnProperty('cta-position') ? currentFrame['cta-position'].x : 59;
	callToAction.y = currentFrame.hasOwnProperty('cta-position') ? currentFrame['cta-position'].y : 450;
