...
function createTextIntroductionFrame() {
	...
	headline.x = currentFrame.hasOwnProperty('image-x-position') ? currentFrame['image-x-position'] : 364;
	headline.y = currentFrame.hasOwnProperty('image-y-position') ? currentFrame['image-y-position'] : 45;
	headline.alpha = 0;
	...
	if ( currentFrame.hasOwnProperty("image-sheen") && currentFrame["image-sheen"] === "yes" && currentFrame.gradient && currentFrame.gradient === "yes") {
		...
		mask1.regY = gradient1.getBounds().height;
		mask1.y = clone1.y;
		mask1.x = clone1.x - clone1.getBounds().width * 0.6;
		mask1.rotation = 15;
		clone1.mask = mask1;
		createjs.Tween.get(mask1).wait(parseInt(currentFrame['image-animation-in'].duration)).to({x:728},1500);
	}
		...
		mask2.regY = headline.image.height;
		mask2.y = clone2.y;
		mask2.x = clone2.x - clone2.getBounds().width * 0.6;
		mask2.rotation = 15;
		clone2.mask = mask2;
		createjs.Tween.get(mask2).wait(parseInt(currentFrame['image-animation-in'].duration)).to({x:728},1500);
	}
...
function createOfferFrameTypeOne() {
	...
	headline.regX = Math.floor(headline.image.width * 0.5);
	headline.regY = Math.floor(headline.image.height * 0.5);
	headline.x = currentFrame.hasOwnProperty("headline-x-position") ? currentFrame['headline-x-position'] : 129;
	headline.y = currentFrame.hasOwnProperty("headline-y-position") ? currentFrame['headline-y-position'] : 45;
	headline.cache(0,0,headline.image.width,headline.image.height);
	...
	if ( currentFrame.hasOwnProperty("headline-sheen") && currentFrame["headline-sheen"] === "yes" && currentFrame['headline-gradient'] && currentFrame['headline-gradient'] === "yes") {
		...
		mask1.rotation = 15;
		clone1.mask = mask1;
		createjs.Tween.get(mask1).wait(parseInt(currentFrame['headline-animation-in'].duration)).to({x:728},1500);
	}
		...
		mask2.rotation = 15;
		clone2.mask = mask2;
		createjs.Tween.get(mask2).wait(parseInt(currentFrame['headline-animation-in'].duration)).to({x:728},1500);
	}
	...
	if ( currentFrame.hasOwnProperty("relational-image") ) {
		...
		relational.regY = Math.floor(relational.image.height * 0.5);
		relational.x = currentFrame.hasOwnProperty('relational-x-position') ? currentFrame['relational-x-position'] : 506;
		relational.y = currentFrame.hasOwnProperty('relational-y-position') ? currentFrame['relational-y-position'] : 45;
		...
		if ( currentFrame.hasOwnProperty("relational-sheen") && currentFrame["relational-sheen"] === "yes" && currentFrame['relational-gradient'] && currentFrame['relational-gradient'] === "yes") {
			...
			mask3.regY = gradient3.getBounds().height;
			mask3.x = 450;
			mask3.rotation = 15;
			clone3.mask = mask3;
			createjs.Tween.get(mask3).wait(parseInt(currentFrame['relational-image-animation-in'].duration)+1000).to({x:728},1000);
		}
			...
			mask4.regY = relational.image.height;
			mask4.x = 450;
			mask4.rotation = 15;
			clone4.mask = mask4;
			createjs.Tween.get(mask4).wait(parseInt(currentFrame['relational-image-animation-in'].duration)+1000).to({x:728},1000);
		}
...
function createOfferFrameTypeTwo() {
	...
	if ( currentFrame.hasOwnProperty("relational-image") ) {
		...
		if ( currentFrame.hasOwnProperty("relational-sheen") && currentFrame["relational-sheen"] === "yes" && currentFrame['relational-gradient'] && currentFrame['relational-gradient'] === "yes") {
			...
			var mask3 = new createjs.Shape(new createjs.Graphics().beginFill("red").drawRect(0,0,10,gradient3.getBounds().height*2));
			mask3.regY = gradient3.getBounds().height;
			mask3.x = gradient3.x - gradient3.getBounds().width * 1.2;
			mask3.rotation = 15;
			clone3.mask = mask3;
			createjs.Tween.get(mask3).wait(parseInt(currentFrame['relational-image-animation-in'].duration)+1000).to({x:728},1000);
		}
			...
			var mask4 = new createjs.Shape(new createjs.Graphics().beginFill("red").drawRect(0,0,10,relational.image.height*2));
			mask4.regY = relational.image.height;
			mask4.x = clone4.x - clone4.getBounds().width * 1.2;
			mask4.rotation = 15;
			clone4.mask = mask4;
			createjs.Tween.get(mask4).wait(parseInt(currentFrame['relational-image-animation-in'].duration)+1000).to({x:728},1000);
		}
...
function createContentFrame() {
	...
	if ( currentFrame.hasOwnProperty("relational-image") ) {
		...
		if ( currentFrame.hasOwnProperty("relational-sheen") && currentFrame["relational-sheen"] === "yes" && currentFrame['relational-gradient'] && currentFrame['relational-gradient'] === "yes") {
			...
			mask3.regY = gradient3.getBounds().height;
			mask3.y = clone3.y;
			mask3.x = clone3.x - clone3.getBounds().width * 1.2;
			mask3.rotation = 15;
			clone3.mask = mask3;
			createjs.Tween.get(mask3).wait(parseInt(currentFrame['relational-image-animation-in'].duration)+1000).to({x:728},1000);
		}
...
function createPriceFrame() {
	...
	headline.regX = 0;
	headline.regY = 0;
	headline.x = currentFrame.hasOwnProperty("headline-x-position") ? currentFrame['headline-x-position'] : 15;
	...
	if ( currentFrame.hasOwnProperty("relational-image") ) {
		...
		if ( currentFrame.hasOwnProperty("relational-sheen") && currentFrame["relational-sheen"] === "yes" && currentFrame['relational-gradient'] && currentFrame['relational-gradient'] === "yes") {
			...
			mask3.rotation = 15;
			clone3.mask = mask3;
			createjs.Tween.get(mask3).wait(parseInt(currentFrame['relational-image-animation-in'].duration)).to({x:728},1500);
		}
		else if ( currentFrame.hasOwnProperty("relational-sheen") && currentFrame["relational-sheen"] === "yes" && currentFrame['relational-gradient'] && currentFrame['relational-gradient'] === "no") {
			animateStraplineIn(relational, currentFrame['relational-image-animation-in'], currentFrame['relational-image-animation-out'], currentFrame['relational-image-animation-duration']);
			...
			mask4.rotation = 15;
			clone4.mask = mask4;
			createjs.Tween.get(mask4).wait(parseInt(currentFrame['relational-image-animation-in'].duration)).to({x:728},1500);
		}
		else if ( currentFrame.hasOwnProperty("relational-sheen") && currentFrame["relational-sheen"] === "no" && currentFrame['relational-gradient'] && currentFrame['relational-gradient'] === "yes") {
			var gradient4 = new createjs.Shape(new createjs.Graphics().beginLinearGradientFill([currentFrame.hasOwnProperty('relational-gradient-colour-1') ? currentFrame['relational-gradient-colour-1'] : 'rgba(247,145,2,1)',currentFrame.hasOwnProperty('relational-gradient-colour-2') ? currentFrame['relational-gradient-colour-2'] : 'rgba(239,45,45,1)',currentFrame.hasOwnProperty('relational-gradient-colour-3') ? currentFrame['relational-gradient-colour-3'] : 'rgba(24,88,226,1)'],[0,0.5,1],0,0,relational.image.width,0).drawRect(0,0,relational.image.width,relational.image.height));
			gradient4.filters = [
...
function createRoundelFrame() {
	...
	headline.regX = Math.floor(headline.image.width * 0.5);
	headline.regY = Math.floor(headline.image.height * 0.5);
	headline.x = currentFrame.hasOwnProperty("headline-x-position") ? currentFrame['headline-x-position'] : 152;
	headline.y = currentFrame.hasOwnProperty("headline-y-position") ? currentFrame['headline-y-position'] : 45;
	headline.cache(0,0,headline.image.width,headline.image.height);
	...
	if ( currentFrame.hasOwnProperty("roundel-sheen") ) {
		if ( currentFrame['roundel-sheen'] === "yes"  ) {
			...
			roundelSheenMask.x = 364;
			roundelSheenMask.y = 45;
			...
			createjs.Tween.get(roundelSheen).wait(1000).to({x:410},500).call(function(){
...
function createRoundelEndFrame() {
	...
	headline.regX = Math.floor(headline.image.width * 0.5);
	headline.regY = Math.floor(headline.image.height * 0.5);
	headline.x = currentFrame.hasOwnProperty("headline-x-position") ? currentFrame['headline-x-position'] : 160;
	headline.y = currentFrame.hasOwnProperty("headline-y-position") ? currentFrame['headline-y-position'] : 15;
	headline.cache(0,0,headline.image.width,headline.image.height);
	...
	if ( currentFrame.hasOwnProperty("relational-image") ) {
		...
		relational.regX = Math.floor(relational.image.width * 0.5);
		relational.regY = Math.floor(relational.image.height * 0.5);
		relational.x = currentFrame.hasOwnProperty('relational-x-position') ? currentFrame['relational-x-position'] : 160;
		relational.y = currentFrame.hasOwnProperty('relational-y-position') ? currentFrame['relational-y-position'] : headline.y + headline.image.height;
		relational.cache(0,0,relational.image.width,relational.image.height);
		...
		if ( currentFrame.hasOwnProperty("relational-sheen") && currentFrame["relational-sheen"] === "yes" && currentFrame['relational-gradient'] && currentFrame['relational-gradient'] === "yes") {
			...
			mask4.rotation = 15;
			clone4.mask = mask4;
			createjs.Tween.get(mask4).wait(parseInt(currentFrame['relational-image-animation-in'].duration)+1000).to({x:728},1500);
		}
		else if ( currentFrame.hasOwnProperty("relational-sheen") && currentFrame["relational-sheen"] === "no" && currentFrame['relational-gradient'] && currentFrame['relational-gradient'] === "yes") {
			var gradient4 = new createjs.Shape(new createjs.Graphics().beginLinearGradientFill([currentFrame.hasOwnProperty('relational-gradient-colour-1') ? currentFrame['relational-gradient-colour-1'] : 'rgba(247,145,2,1)',currentFrame.hasOwnProperty('relational-gradient-colour-2') ? currentFrame['relational-gradient-colour-2'] : 'rgba(239,45,45,1)',currentFrame.hasOwnProperty('relational-gradient-colour-3') ? currentFrame['relational-gradient-colour-3'] : 'rgba(24,88,226,1)'],[0,0.5,1],0,0,relational.image.width,0).drawRect(0,0,relational.image.width,relational.image.height));
			gradient4.filters = [
	...
	if ( currentFrame.hasOwnProperty("cta-sheen") && currentFrame['cta-sheen'] === "yes" ) {
		...
		callToActionMask.graphics.beginFill('red').drawRoundRect(0, 0, 125, 60, 8);
		callToActionMask.regX = 62.5;
		callToActionMask.regY = 30;
		callToActionMask.x = 425;
		callToActionMask.y = 45;
		...
		callToActionSheen.y = -10;
		callToActionSheen.x = 330;
		...
		createjs.Tween.get(callToActionSheen).wait(1500).to({x:580},500).call(function(){
	...
	if ( currentFrame.hasOwnProperty("roundel-sheen") ) {
		if ( currentFrame['roundel-sheen'] === "yes" ) {
			...
			createjs.Tween.get(roundelSheen).wait(2000).to({x:600},500).call(function(){
				stageContent.removeChild(roundelSheen);
			});
		}
	}
...
function createCustomEndFrame() {
	...
	callToAction.regX = callToAction.image.width * 0.5;
	callToAction.regY = callToAction.image.height * 0.5;
	callToAction.x = currentFrame.hasOwnProperty('cta-position') ? currentFrame['cta-position'].x : 530;
	callToAction.y = currentFrame.hasOwnProperty('cta-position') ? currentFrame['cta-position'].y : 45;
	...
	if ( currentFrame.hasOwnProperty("cta-sheen") && currentFrame['cta-sheen'] === "yes" ) {
		...
		createjs.Tween.get(callToActionSheen).wait(1500).to({x:600},500).call(function(){
			stageContent.removeChild(callToActionSheen);
		});
	}
